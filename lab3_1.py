...
def main():
    print("Вариант 13: y=cos(x)+x, X* = 1.0")
    print("a) Xi = 0, pi/6, 2pi/6, 3pi/6")
    print("b) Xi = 0, pi/6, pi/4, pi/2")
    X_a = np.array([0, math.pi / 6, math.pi / 3, math.pi / 2])
    X_b = np.array([0, math.pi / 6, math.pi / 4, math.pi / 2])
    X = 1.0
    Yi = np.array([])
